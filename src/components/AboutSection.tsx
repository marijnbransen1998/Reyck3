              ...
              <div className="px-4">
                <div className="max-w-[280px] text-white space-y-3 pl-8">
                  ...
                  <p className="text-sm leading-snug font-optien mt-4">
                    ...
                    omschreven wordt als ‘Ziggo Dome-ready’. Reyck is niet vies
                    van stevig gitaarwerk, maar ook zeker niet bang voor een
                    catchy popsong. In 2027 verschijnt het debuutalbum dat
                    volledig is gewijd aan de verzwegen kanten van de liefde.
                  </p>
                </div>
              </div>
            </div>
