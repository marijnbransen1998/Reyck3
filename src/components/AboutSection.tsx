...
const AboutSection: React.FC = () => {
  ...
  return (
    <section ref={sectionRef} className="mb-16 relative">
      ...
      {/* About Text */}
      <div className="relative min-h-[400px] flex items-center justify-center bg-white/10 backdrop-blur-sm rounded-lg">
        <div className={`text-center max-w-2xl mx-auto px-8 py-12 transform transition-all duration-1000 ${
